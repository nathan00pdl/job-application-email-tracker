 ...
 * into the application's DataSource, so no test-specific datasource wiring is needed
 * and Flyway runs the production migrations against it.
 */
@SpringBootTest(properties = {
        ...
        // two keys — rather than shipping a test application.yml — keeps the real
        // configuration file as the single source of truth for everything else.
